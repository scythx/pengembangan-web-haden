...
VALUES
  ...
  ('Manchester United F.C.', 4, 'England'),
  ('New York Yankees', 3, 'United States');
...
VALUES
  ...
  ('Hati Neymar sangat besar- bos PSG Tuchel memuji pemain Brasil sebab memberikan penalti kepada Mbappe untuk mengakhiri kekeringan', 'Harden', 'Pemain internasional Prancis itu mengakhiri 9 pertandingan di Liga Champions tanpa berhasil dengan mencetak 2 berhasil melawan Basaksehir', '2020-12-10', true, 3, 11),
  ('‘Tujuan kami ialah jadi lebih baik’ - Bernardo Silva mengatakan motivasi Manchester City di Liga Champions', 'Harden', 'Raksasa Liga Premier sudah berjuang di kompetisi klub top Eropa serta ingin mengganti nasib mereka, menurut playmaker tersebut.', '2020-11-17', false, 3, 11),
  ('Bos Liverpool Klopp menerangkan kenapa Salah bermain penuh sepanjang 90 menit melawan Midtjylland', 'Harden', 'Pemain internasional Mesir itu tampil sepanjang durasi game walaupun The Reds sudah mengamankan pertumbuhan Liga Champions', '2020-11-17', false, 3, 11),
  ...
  ('Cam Newton, Kekalahan Patriots dari Rams setelah mencetak 45 poin di minggu sebelumnya', 'Harden', 'Hal baik hanya bertahan untuk New England Patriots selama satu minggu. Kekalahan 24-3 dari Los Angeles Rams menghancurkan semuanya.', '2020-11-17', true, 2, 3);
