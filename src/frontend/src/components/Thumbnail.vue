<template>
  <div id="container">
    <div
    v-if="this.$store.state.authentication.identity != undefined && (favSports!=null || favLeagues!=null || favTeams!=null)">
      <div v-if="mappedArticlesSport!=null">
        <div
            v-for="(item, index) in mappedArticlesSport"
            :key="index"
        >
            <v-list 
                dense
            ...
            <h1 id="title" class="h1 font-weight-light"
              :style="$vuetify.breakpoint.lg ? 'font-size:3vw' : 'font-size:5vw'">{{getSportName(item.id_sport)}}</h1>
            <v-list-item
      ...
      <div v-if="mappedArticlesLeague.length!=0">
        <div
            v-for="(item, index) in mappedArticlesLeague"
            :key="index"
        >
            <v-list 
                dense
      ...
      <div v-if="mappedArticlesTeam!=null">
        <div
            v-for="(item, index) in mappedArticlesTeam"
            :key="index"
        >
            <v-list 
                dense
            ...
            >
            <h1 id="title" class="h1 font-weight-light"
              :style="$vuetify.breakpoint.lg ? 'font-size:3vw' : 'font-size:5vw'">{{getTeamName(item.id_team)}}</h1>
            <v-list-item
                v-for="(article, id) in item.articles.slice(0,2)"
                :key="id"
                ripple
