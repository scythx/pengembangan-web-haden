    ...
    <div class="wrapper">
        ...
        <nav class="sidebar-content" id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="active">
                    <a href="" id="home-container">
                        <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-house mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <a @click="onMediaMenuClick">
                        <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-camera mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="setting-item-sidebar">
                    <a href="#">
                        <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-gear mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="signout-item-sidebar">
                    <a href="#">
                        <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-door-open mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navigation-bar">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#" id="branding">HARDEN</a>
                    <button type="button" id="sidebarCollapse" class="navbar-btn" @click="onSideBarButtonClick()">
                        <span></span>
                        <span></span>
                        <span></span>
                    </button>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a href="#" id="user-container">
                                    <div class="media">
                                        <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg" id="user-icon">
                                            <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                                            <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                            <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
                                        </svg>
                                        <div class="media-body">
                                            <h5 id="username">My Name</h5>
                                        </div>
                                    </div>
                                </a>
                            </li>
...
export default {
  ...
  methods: {
    onSideBarButtonClick() {
      this.$jquery('#sidebar').toggleClass('active');
      this.$jquery('#sidebarCollapse').toggleClass('active');
    },
    onMediaMenuClick() {
